...
ob_start();
$API_KEY = "توكن"; //توكنك
$admin = 1930822771; //ايديك
$c = "@maxsource"; //قناتك
define("API_KEY",$API_KEY);
function bot($YOUSEEF,$Sauodi=[]){
$YOUSEEFURL = "https://api.telegram.org/bot".API_KEY."/".$lukas;
$curl = curl_init();
...
🇮🇶 ┇ [حساب المطور YL](http://telegram.me/a5j4z)
🇮🇶 ┇ [قناة المطور](http://telegram.me/max_one777)
🇮🇶 ┇ [مجموعتي](https://t.me/)
🇮🇶 ┇ [قناة اليوتيوب]()
",
]);
